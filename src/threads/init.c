...
static void shell_command_whoami(void);
static char* read_line(void);
static void shell_command_ram (void);
...
static void run_shell (void){
  ...
  while (true){
    ...
    if (strcmp(command, "whoami") == 0){
      ...
      printf("Exiting interactive shell...Have a nice day RUMA!\n");
      break;
    }
...
static void shell_command_whoami(void){
  printf("R.M.R.Chathuranga 230104E\n");
}

static void shell_command_ram (){
  printf ("%"PRIu32" kB\n",init_ram_pages * PGSIZE / 1024);
}
